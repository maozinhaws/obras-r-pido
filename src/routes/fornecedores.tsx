      ...
      <div className="px-5 lg:px-10 py-6 space-y-4">
        ...
        {filtrados.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {filtrados.map((f) => (
              <div key={f.id} className="bg-surface brutal-border p-4 flex flex-col gap-2">
                <div>
                ...
                <div className="flex gap-2 pt-2 mt-auto border-t-2 border-ink/20">
                  {f.telefone && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="flex-1 bg-success text-ink brutal-border-thin px-2 py-1.5 text-[10px] font-black uppercase tracking-widest brutal-press flex items-center justify-center gap-1"
                    >
                  ...
                  <button
                    ...
                    className="brutal-border-thin px-2 py-1.5 brutal-press"
                    aria-label="Editar"
                  >
